...
MouseArea {
    ...
    property bool splitIfVertical: Plasmoid.configuration.splitIfVertical
    ...
    onSplitIfVerticalChanged:     { timeFormatCorrection(Qt.locale().timeFormat(Locale.ShortFormat)) }
